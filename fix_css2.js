...
// We are going to rebuild cova-partners.html using cova-about.html as the base shell.
let aboutContent = fs.readFileSync('cova-about.html', 'utf8');

const headerRegex = /<!doctype html>[\s\S]*?<\/nav>\s*<div class="mobile-menu" id="mobileMenu">[\s\S]*?<\/div>\s*<\/div>/;
const headerMatch = aboutContent.match(headerRegex);

const footerRegex = /<footer>[\s\S]*?<\/html>/;
const footerMatch = aboutContent.match(footerRegex);
...
if (headerMatch && footerMatch) {
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 24px;">
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">AXA Mansard</div>
            </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Leadway Assurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A+ rated</div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">AIICO Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General, Life & Health</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Mutual Benefits</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General & Life</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Custodian Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A+ rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General & Life</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">NEM Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Cornerstone Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General & Life</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Linkage Assurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General Insurance</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Heirs Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General & Life</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Zenith Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General Insurance</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Sovereign Trust</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General Insurance</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Reliance HMO</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Hygeia HMO</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A+ rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">Health Insurance</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              ...
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Leadway Health</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A+ rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">Health Insurance</div>
          </div>
          ...
          <div style="background: var(--white); border: 1px solid var(--border); border-radius: 24px; padding: 24px;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
              <div style="width: 48px; height: 48px; background: var(--green-soft); display: grid; place-items: center; border-radius: 12px; font-weight: 800; color: var(--green); font-size: 12px;">COR</div>
              <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.02em; color: var(--ink);">Coronation Insurance</div>
            </div>
            <div style="font-size: 14px; color: var(--green); font-weight: 600; margin-bottom: 4px;">A rated</div>
            <div style="font-size: 14px; color: var(--ink-light);">General & Life</div>
          </div>
  ...
  let finalContent = headerMatch[0] + '\n' + partnersHTML + '\n' + footerMatch[0];
  finalContent = finalContent.replace('<title>About Us — Cova</title>', '<title>Our Partners — Cova</title>');
  
  fs.writeFileSync('cova-partners.html', finalContent);
  console.log('Successfully rebuilt cova-partners.html perfectly from head to toe!');
} else {
  console.log('Failed to match header and footer from cova-about.html');
}